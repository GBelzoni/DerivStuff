##NOTE TO LINK TO LIBRARIES CREATED BY BOOSTPYTHON YOU HAVE TO HAVE LD_LIBRARY_PATH variable set
##Easiest way to have the libs found is move them to somewhere already on the path
##Look in /etc/ld.conf.so to find available. Can add location and run ldconfig as sudo
##I've just used /usr/local/lib seems to work.
...
# os.environ['LD_LIBRARY_PATH'] = "${workspace_loc}/Cpp_Rate_Curve/Debug"
